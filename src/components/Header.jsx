        ...
        <div className="bg-primary/95 border-b border-white/10 hidden lg:block">
          <div className="max-w-7xl mx-auto px-4 py-1.5 flex items-center justify-between text-xs text-white/70">
            ...
            <div className="flex items-center gap-2">
              {v('header_tour_label') && (
                <>
                  <Link to={v('header_tour_link')} className="flex items-center gap-1.5 text-accent font-semibold hover:text-yellow-300 transition-colors text-xs mr-1">
                    {v('header_tour_label')}
                  </Link>
          ...
          <Link to="/" className="flex items-center gap-3 flex-shrink-0">
            ...
            <div className="hidden sm:block">
              <div className="text-white font-bold text-sm leading-tight" style={{ fontFamily: 'Playfair Display, serif' }}>
                {businessName.replace(/^Hotel /i, '')}
              </div>
              <div className="text-accent text-xs">{v('brand_city')}</div>
            </div>
          </Link>
          ...
          <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }}
            ...
            <div className="px-4 pt-4 pb-2 flex items-center justify-between border-b border-white/10">
              <div>
                ...
                <p className="text-accent text-xs">{v('header_menu_subtitle')}</p>
              </div>
            ...
            <div className="px-4 py-3 flex flex-col gap-2">
              ...
              {v('header_tour_label') && (
                <Link to={v('header_tour_link')} onClick={() => setMenuOpen(false)}
            ...
            <div className="px-4 pb-4 flex items-center justify-between">
              <p className="text-white/40 text-xs">{v('header_menu_location')}</p>
